...
private:
	...
	const bitset<8> fillingBytes[2] = { bitset<8>(236), bitset<8>(17)}; // заполняющийе байты
	list<bitset<8>> filledBits; // новый список - служебная информация + сообщение + заполняющие байты
	...
	const int blocksCount[40] = { 1, 1, 1, 2, 2, 4, 4, 4, 5, 5,
		...
		23, 25, 26, 28, 29, 31, 33, 35, 37, 38, 40, 43, 45, 47, 49 }; // количество блоков при разбиении
	const int correctionBytesCount[40] = { 10, 16, 26, 18, 24, 16, 18,
		22, 22, 26, 30, 22, 22, 24, 24, 28, 28, 26, 26, 26, 26, 28, 28,
		28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28 }; // количество блоков коррекции на один блок
